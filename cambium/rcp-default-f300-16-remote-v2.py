...
def RCP_Bidyadanga_F300_Configuration():
    with open('provisioningpi/cambium/rcp-default-f300-16-remote-v2.py') as file:
         exec(file.read())
...
print (Fore.GREEN + "Fetching default config template")
...
print_v1.print_label(" - SPARE",ip_address,"device","DEFAULT")
print(Fore.GREEN + "Printing label for F300 box")
print_v1.print_label(" - SPARE",ip_address,"box","DEFAULT")
...
gsheet.add_to_sheet(serial_number, mac_address, "SPARE_F300-16", ip_address, fwv, hardware, smc_ping)
