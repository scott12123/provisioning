...
devicename = "MOR_F300-25SM_EXTXXXX_IP_Y_Z" #Edit this for each site
snmp_trap_community = "SNMP_Mornington" #Edit for each site
...
functions.log(f"Starting MOR_F300-25 script...","INFO")
