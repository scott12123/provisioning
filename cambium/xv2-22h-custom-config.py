...
def XV2_22h_Generic_Configuration():
    with open('/home/pi/provisioningpi/cambium/xv2-22h-custom-config.py') as file:
         exec(file.read())
...
print (Fore.GREEN + "Checking for factory default XV2-22H (Indoor Unit) connected on 192.168.0.1")
while True:
...
#Firmware - upgrade to 6.6.0.2-r5 if necessary.
while True:
    ...
    if '6.6.0.2-r5' in firmware:
        print(Fore.GREEN + "Currently on v6.6.0.2-r5. No upgrade needed.")
        break
    else:
      print(firmware)
      print(Fore.RED + "Need to update to v6.6.0.2-r5")
      print(Fore.GREEN + "Updating firmware to v6.6.0.2-r5")

      #Update firmware
      print("Updating firmware")
      first_command = 'upgrade http://192.168.0.50/firmware/xv222h_xv221x_xv223t-6.6.0.2-r5.cimg verbose'
