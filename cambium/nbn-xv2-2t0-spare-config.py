...
def RCT_XV2_Generic_Configuration():
    with open('cambium/nbn-xv2-2t0-spare-config.py') as file:
         exec(file.read())
...
device_name = "NBN_SPARE_XV2_AP_0_213"
...
source = '/mnt/usbstick/nbn/nbn-Generic-XV2-2T0-IP-10.255.0.213_v3.0.txt'
