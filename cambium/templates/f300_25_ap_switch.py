...
devicename = "SHORTNAME_F300-25SM_APXXXX_IP_Y_Z" #Edit this for each site
...
#    print(Fore.GREEN + "Printing label for F300 radio")
    print_v1.print_label_switch(f"AP{ext}",ip_address,"device",site,mac_address)
#    print(Fore.GREEN + "Printing label for F300 box")
    #print_v1.print_label_switch(f"AP{ext}",ip_address,"box",site,mac_address)
...
print("Must run this script from root directory")
...
def run_process(ap, ip_queue):
    ...
    devicename = "SHORTNAME_F300-25SM_APXXXX_IP_Y_Z"
